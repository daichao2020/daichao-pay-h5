			...
			<div class="card-bd">
				...
				<div class="product-info">
					<div class="info-row bottom-line">
						<p class="info-title">Loan Amount (₹)</p>
						<div class="info-list">
					...
					<div class="desc-row small flex bottom-line">
						...
						<div class="bold">₹{{interest}}</div>
					</div>
					<div class="desc-row small flex bottom-line">
						<div class="flex-1 text-left">
							Repayment amount(<span class="small red">-₹{{auditFee}}</span>)
						</div>
						<div class="bold">₹{{repayment}}</div>
					</div>
			...
			<div class="card-ft">
				...
				<div class="warn-tips">
					...
					<div class="tips-bd">
						...
						<div class="tip-item bottom-line">
							<p>③ Credit Evaluation Fee</p>
							<p class="tip-desc">• The fee is used to assess your credit  status and  query your credit history.</p>
							<p class="tip-desc">• Your credit report will be generated for you.</p>
