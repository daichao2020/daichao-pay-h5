<template>
	<div class="default-page terms-page">
...
view to facilitate lending and borrowing activities, including providing other
...
Financial Institution under the Companies Act, 2013 or the Banking Regulation
Act, 1949 or any other laws for the time being in force in India. Cashpie is
also not a deposit taking company or a chit fund or a company offering any
...
their respective capacities as lenders / borrowers / users of other financial
products as set out in the Platform. Cashpie, through its Platform displays
various products provided by its partners or third parties. In addition to the
...
shall ensure that such calls received by You are pursuant to You providing Us
...
able to get the best available offers to suit the needs of the Users. The
...
and conditions detailed hereinafter. By registering on the Platform, the User
hereby undertakes to agree and abide by the Terms &amp; Conditions detailed
herein. If the User violates any of these Terms &amp; Conditions, or otherwise
violates an agreement entered into through the medium of the Platform, Cashpie
may terminate the User’s membership, delete his/her profile and any content or
information posted online by the User on the Platform and / or prohibit the
User from using or accessing the Platform at any time in its sole discretion,
...
1 day of modification. Cashpie does not take responsibility in case the email
address provided by the User is either incorrect or does not belong to the
user. The User’s continued use of the Platform following the notification of
...
Privacy Policy. You are responsible for maintaining the confidentiality and
security of Your account, password, activities that occur in or through Your
account and for restricting access to Your computer to prevent unauthorized
access to Your account. You agree to accept responsibility for all activities
that occur under Your account or password. You should take all necessary steps
to ensure that the password is kept confidential and secure and should inform
us immediately if You have any reason to believe that Your password has become
known to anyone else, or if the password is being, or is likely to be, used in
an unauthorized manner. Please ensure that the details You provide Us with are
true, correct, accurate and complete. Upon Cashpie gaining knowledge of having
any reasonable suspicion that the information provided by You is wrong,
inaccurate or incorrect, Cashpie shall immediately terminate Your account
without any notice to You in this regard. In the event of any changes to the
...
be applicable. Any unauthorized access to the Platform or any networks, servers
or computer systems connected to Platform and any attempt to modify, adapt,
translate or reverse engineer any part of the Platform or re-format or frame
any portion of the pages of the Platform, save to the extent expressly
permitted by these Terms &amp; Conditions, is not permitted. This license is
non-transferable and does not permit any resale or commercial use of this
Platform or its contents; any downloading or copying of account information for
the benefit of anyone other than Your use; or any use of data mining, robots,
or similar data gathering and extraction tools. The Platform or any portion of
...
for any commercial purpose without express written consent of Cashpie and / or
...
that every User remains in consonance with the Terms &amp; Conditions provided
herein. Subject to the Terms &amp; Conditions mentioned herein, Cashpie shall
also have the liberty to remove any objectionable content which is in
contravention of the Terms &amp; Conditions herein or share such information
...
end; and (b) User must stop using the Platform forthwith. Cashpie reserves the
...
consequential damages or any loss of revenue or profits arising under or relating
to these Terms &amp; Conditions. To the maximum extent permitted by law, You
waive, release, discharge and hold harmless Cashpie, its affiliated and
subsidiary companies, and each of their directors, officers, employees, and
...
Cashpie. In case the User does not disclose any information to Cashpie, and the
same is not found out at the first instance by Cashpie despite all measures
adopted to certify the ratings or credibility of a User, Cashpie shall not be
responsible for any claims or liabilities. Cashpie in any event is not
responsible for any default in return of money that is borrowed from the lender
and the lender shall have the exclusive right to initiate proceedings against
the defaulter borrower. Cashpie shall to the best of its abilities aid the
concerned User in terms of provision of information to initiate any legal
proceedings. However, Cashpie shall not be responsible for any default on
behalf of the User. Cashpie is an information platform and the User is entitled
...
the Services and all liabilities and obligations of the customers / User with
respect to the financial products provided by the partners shall be governed by
...
operation of the Platform will be error free and/or uninterrupted.
Consequently, Cashpie assumes no liability whatsoever for any monetary or other
damage suffered by You on account of the delay, failure, interruption, or corruption
of any data or other information transmitted in connection with use of the
Platform; and/or any interruption or errors in the operation of the Platform.
This limitation of liability clause shall prevail over any conflicting or
inconsistent provision contained in any of the documents / content comprising
this Terms &amp; Conditions. It is up to You to take precautions to ensure that
...
FITNESS FOR A PARTICULAR PURPOSE AND NONINFRINGEMENT. COMPANY MAKE NO WARRANTY
...
OBTAINED BY YOU THROUGH THE SERVICE WILL MEET YOUR EXPECTATIONS, OR (V) ANY
ERRORS IN THE TECHNOLOGY WILL BE CORRECTED AND YOU ARE SOLELY RESPONSIBLE FOR
...
USE, DATA OR OTHER INTANGIBLE LOSSES, EVEN IF COMPANY OR SERVICE PROVIDER HAS
BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES, RESULTING FROM: (i) THE USE OR
THE INABILITY TO USE THE SERVICE / PLATFORM; (ii) THE COST OF GETTING
...
TRANSMISSIONS OR DATA; (v) STATEMENTS OR CONDUCT OF ANYONE ON THE SERVICE; EVEN
IF THE PROVIDER HAS BEEN ADVISED PREVIOUSLY OF THE POSSIBILITY OF SUCH DAMAGES;
OR (vii) ANY OTHER MATTER RELATING TO THE SERVICE. THE MAXIMUM LIABILITY OF
...
without limitation legal fees and expenses, arising out of or related to Your
use or misuse of the Services or of the Website or App or Platform, any
violation by You of these Terms &amp; Conditions, or any breach of the
representations, warranties, and covenants made by You herein or Your
infringement of any intellectual property or other right of any person or
entity, or as a result of any threatening, libelous, obscene, harassing or
offensive material posted/ transmitted by You on the Platform. Cashpie reserves
the right, at Your expense, to assume the exclusive defense and control of any
matter for which You are required to indemnify Cashpie, including rights to
settle, and You agree to cooperate with Cashpies’ defense and settlement of
these claims. Cashpie will use reasonable efforts to notify You of any claim,
...
applications are provided “as is” for User’s convenience only with no warranty,
express or implied, for the information provided within them. Cashpie does not
provide any endorsement or recommendation of any third party website or mobile
application to which the Platform provides a link. Further, the Users consent
...
material using such Content to provide the Service to You. Company and Service
Provider may also use, sell, license, reproduce, distribute and disclose
aggregate, non-personally identifiable information that is derived through Your
use of the Service. By submitting Content, You automatically agree, or promise
that the owner of such Content has expressly agreed that, without any
particular time limit, and without the payment of any fees, Company and its
third party service provider may use the Content for the purposes set out
...
financial products is entirely based on the negotiations between the Users and
third party and neither Cashpie nor its affiliates, contractors, employees,
officers, directors, agents and their third party associates, licensors and
partners have any interest with regard to any financial products assistance
procured by or to a registered User. You acknowledge that Cashpie will not be
responsible for any claim or damage in case of use of the financial products.
Cashpie in no manner warrants or guarantees the performance of a third party
service provider that is providing services through the App. You acknowledge
that Cashpie in no manner guarantees that the Users have provided all the
information on this App which is true and correct including his address, phone
numbers etc. You acknowledge that it is Your responsibility to verify the
information about the person on the Platform and Cashpie is in no manner liable
if the information provided on this App is untrue or incorrect. You acknowledge
that Cashpie is in no manner responsible for any claim of money or damages in
the event one person fails to either grant loan or a person fails to repay the
